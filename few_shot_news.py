...
file = "./results/news_few_shot_gemma.txt"
...
# Load dataset (only for examples)
...
examples, _ = create_examples(dataset, n_examples)
predictions = []

for news in headlines:
    generated_text = few_shot(news, examples)
    predictions.append(
        {
            "headline_id": ids[headlines.index(news)],
            "model": llm.model + " few_shot",
            "headline": news,
